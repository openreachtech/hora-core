...
| [`auto.md`](./auto.md) | **the automatic route.** What `/hora-auto` asks once, how it decides without you, how every stop is shown and resumed, and why it ends at a draft pull request |
