...
| | |
|---|---|
| what a project built with the kit contains, and how to start one | [`hora-boilerplate`](https://github.com/openreachtech/hora-boilerplate) for web, [`hora-boilerplate-mobile`](https://github.com/openreachtech/hora-boilerplate-mobile) for native |
